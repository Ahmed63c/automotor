...
class RentCarModel {
  List<SaleCar> rentCars;
  RentCarModel({this.rentCars});
  factory RentCarModel.fromJson(Map<String, dynamic> json) {
    return RentCarModel(
      rentCars: json['rent_cars'] != null ? (json['rent_cars'] as List).map((i) => SaleCar.fromJson(i)).toList() : null,
    );
  }
}
class SaleCar {
  ...
  factory SaleCar.fromJson(Map<String, dynamic> json) {
    return SaleCar(
      ...
      contact_number: json['contact_number'] =json['contact_number'],
